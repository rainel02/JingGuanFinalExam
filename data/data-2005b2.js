...
const qs = [
  ...
  // ===== 计算题 =====
  {id:"2005B2-calc-1",question:"设某决策问题的决策收益（元/单位）如下表所示：\n方案A1：θ1=4，θ2=5，θ3=6，θ4=7\n方案A2：θ1=2，θ2=4，θ3=6，θ4=9\n方案A3：θ1=5，θ2=7，θ3=3，θ4=5\n方案A4：θ1=3，θ2=5，θ3=6，θ4=8\n方案A5：θ1=3，θ2=5，θ3=5，θ4=5\n请用乐观准则和最小遗憾准则两种方法进行决策。若四种状态概率分别为0.2、0.3、0.3、0.2，以收益期望值法决策方案。",answer:"详见解析",type:"计算",explanation:"(1)乐观准则：Max{7,9,7,8,5}=9→最佳方案A2\n(2)最小遗憾准则：后悔值表A1={1,2,0,2},A2={3,3,0,0},A3={0,0,3,4},A4={2,2,0,1},A5={2,2,1,4}；Max{2,3,4,2,4}，Min=2→方案A1和A4\n(3)期望值：E(A1)=5.5, E(A2)=5.5, E(A3)=5.0, E(A4)=5.5, E(A5)=4.6→方案A1和A4",source:"2005-2006-B2",options:[],url:[]},
  {id:"2005B2-calc-2",question:"某工程各工序的逻辑关系及作业时间如下：\n活动A：无紧前，时间1；活动B：紧前A，时间4；活动C：紧前A，时间3；活动D：紧前A，时间7；活动E：紧前B，时间6；活动F：紧前C和D，时间2；活动G：紧前E和F，时间7；活动H：紧前D，时间9；活动I：紧前G和H，时间4。\n要求：(1)绘制网络图；(2)计算工序I的ES、LS；(3)确定该项目的关键工序和项目的计划时间。",answer:"详见解析",type:"计算",explanation:"ES(I)=18, LS(I)=18; 关键路径：A→D→H→I; 项目计划时间=1+7+9+4=21天",source:"2005-2006-B2",options:[],url:[]},
  {id:"2005B2-calc-3",question:"某工厂计划安排生产A和B两种产品，已知生产单位产品所需的设备和原材料如下：设备A=1,B=2,可用8台时；原材料1：A=4,B=0,可用16kg；原材料2：A=0,B=4,可用12kg。每件A获利2元，B获利3元，求最大利润。",answer:"详见解析",type:"计算",explanation:"线性规划：Max Z=2X₁+3X₂\n约束：X₁+2X₂≤8, 4X₁≤16, 4X₂≤12\n解：X₁=4, X₂=2, MaxZ=14元",source:"2005-2006-B2",options:[],url:[]},
  {id:"2005B2-calc-4",question:"某项目方案净现金流量如下（单位：万元）：0年-2000，1年300，2年500，3年500，4年500，5年1200。设基准收益率10%，用内部收益率确定方案是否可行。（用内插法求解，i₁=12%）",answer:"详见解析",type:"计算",explanation:"i₁=12%时NPV₁=21万元；i₂=14%时NPV₂=-91万元\nIRR=12%+21/(21+91)×2%=12.4%\n因为IRR=12.4%>i₀=10%，方案可行",source:"2005-2006-B2",options:[],url:[]}
];
