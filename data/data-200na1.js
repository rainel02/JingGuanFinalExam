...
const qs = [
  ...
  // ===== 单选题 =====
  {id:"200nA1-single-1",question:"若其他条件不变，某商品价格上升10%，能使购买者总支出增加4%，则这种情况下商品的需求价格弹性为（  ）。",answer:"C",type:"单选",explanation:"商品价格上升10%的同时总支出增加4%，得出需求量的变化为\\(\\frac{1.04}{1.1}-1≈-5.45\\%\\)，意味着需求量下降约6%\n \\(E_{d}=\\frac{ΔQ}{Q}÷\\frac{ΔP}{P}=\\frac{5.45\\%}{10\\%}≈0.545<1\\)",source:"200n-A1",options:["A. 大于1","B. 等于0.4","C. 小于1","D. 等于2.5"],url:[]},
  ...
  // ===== 计算题 =====
  {id:"200nA1-calc-1",question:"某企业要投产一种新产品，投资方案有三个，不同经济形式下的利润如下表所示（单位：元）：\n方案S1：好=10，平=0，差=-1\n方案S2：好=25，平=10，差=5\n方案S3：好=50，平=0，差=-40\n用乐观系数准则（\\(\\alpha_1=0.6, \\alpha_2=0.4\\)）及后悔值准则进行决策。",answer:"课外内容，暂无答案",type:"计算",explanation:"乐观系数法：E(S1)=5.6; E(S2)=17; E(S3)=14→选S2\n后悔值准则：S1 max=40; S2 max=25 min; S3 max=45→选S2",source:"200n-A1",options:[],url:[]},
  {id:"200nA1-calc-2",question:"用图解法求解线性规划问题，并指出问题是具有唯一最优解、无穷最优解还是无界解。",answer:"课外内容，暂无答案",type:"计算",explanation:"",source:"200n-A1",options:[],url:["images/200na1/001.png"]},
  {id:"200nA1-calc-3",question:"某项目净现金流量如下表所示。当基准收益率i0＝20％时，试计算该项目的净现值和内部收益率，并判断该项目的经济性。（见下表）",answer:"详见解析",type:"计算",explanation:"NPV(i=20%)>0; IRR≈23.02%>i₀=20%，项目可行",source:"200n-A1",options:[],url:["images/200na1/002.png"]},
  {id:"200nA1-calc-4",question:"某项目各工序与所需时间以及各工序的先后关系如下表所示：\n要求：(1)绘制网络图；(2)计算工序I的ES、LS；(3)确定该项目的关键工序和项目的计划时间。",answer:"详见解析",type:"计算",explanation:"ES(I)=9, LS(I)=10; 关键路径：B→E→H→L; 项目计划时间=26天",source:"200n-A1",options:[],url:["images/200na1/003.png"]},
